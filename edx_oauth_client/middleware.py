...
class SeamlessAuthorization:
    cookie_name = settings.CUSTOM_OAUTH_PARAMS.get("COOKIE_NAME", "authenticated")
    cookie_domain = settings.CUSTOM_OAUTH_PARAMS.get("COOKIE_DOMAIN")
    provider_url = settings.CUSTOM_OAUTH_PARAMS.get("PROVIDER_URL", "")
    provider_logout_url_path = settings.CUSTOM_OAUTH_PARAMS.get("LOGOUT_URL_PATH", "logout")
